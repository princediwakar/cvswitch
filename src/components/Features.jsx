    ...
    <div id="features">
      <div className="max-w-7xl mx-auto py-20 px-6 md:px-12 xl:px-6">
        <div className="md:w-2/3 lg:w-1/2">
          ...
          <p className="text-gray-600 dark:text-gray-300">CV Switch utilizes advanced AI to enhance your resume for any job role. Upload your resume, type a prompt, and watch as it gets transformed to suit your desired job. Ideal for professionals, job seekers, and students.</p>
        </div>
        <div
